...
void draw(){
  ...
  text(ep1, width/2, 795 - frameCount);

  text(titulo, width/2, 835 - frameCount);
  
  fill(blanco); 

  text(direc, width/2, (800+40) - tamTexto2);

  text(script, width/2, (840+40) - tamTexto2);

  text(producer, width/2, (880+40) - tamTexto2);
  
  text(cine, width/2, (920+40) - tamTexto2);

  text(montaje, width/2, (960+40) - tamTexto2);
  ...
  text(chObi, width/2, (1500+40) - tamTexto2);

  text(chPadme, width/2, (1540+40) - tamTexto2);

  text(chVader, width/2, (1580+40) - tamTexto2);
  
  text(chShmi, width/2, (1620+40) - tamTexto2);

  text(chYoda, width/2, (1660+40) - tamTexto2);
